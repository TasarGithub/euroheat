...
<div class="gerb_b">
<img src="/public/images/dubna_gerb.jpg" />
<br />
Город: Дубна<br />
Расстояние от МКАД: 98 км.<br />
Площадь: 70,44 км2<br />
Население: 75 179 чел.
</div>

<p>Предлагаем в аренду бесшумные дизельные электростанции (ДЭС) с подачей в Дубну. Все генераторы – не старше 5 лет, в новых защитных контейнерах.</p>
<p>Мы <a href="/uslugi/dostavka/">доставляем генераторы</a> прямо на площадку. Сами <a href="/uslugi/montazh/">подключаем технику к сети</a>, следим за подачей энергии, а когда работы завершены, отключаем и увозим оборудование. Станции работают под контролем опытного оператора. Это позволяет предотвратить неполадки и удешевить аренду.</p>
<p>Даем гарантию на стабильную работу станций. Техника не заглохнет в самый ответственный момент, не будет шуметь и мешать соседям, не съест больше топлива, чем вы рассчитывали. А если случится поломка, мы пришлем аналогичный генератор не позднее суток.</p>
</div><br /><br />

<a class="order_btn calc calc_2" href="#calc_modal" data-toggle="modal"><div class="arrow_2"></div>Рассчитать аренду ДГУ в Дубне</a><br /><br />


            <div class="h1"><a href="/tarify/">Цена на прокат генератора в Дубне</a></div>
        
<p>Аренда ДЭС в Дубне стоит не дороже, чем прокат в Москве. В этой таблице вы найдете приблизительные расценки – <a href="/uslugi/pod-kljuch/">для аренды под ключ</a> и для проката в режиме простоя. <a href="/raschet/">Рассчитать точную стоимость</a> помогут операторы по телефону.</p>
