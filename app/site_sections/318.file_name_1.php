...
<!-- <h2>ООО «ЕВРОКЛИМА» производит на заказ медно-алюминиевые теплообменники для сушильных камер.</h2> -->
<ul class="ulli">
	<li>В качестве теплоносителя используется вода c температурой +95°С.</li>
	<li>Если вам нужен теплообменник с точными параметрами уже имеющегося, изготовим 100% идентичный аппарат с учетом геометрии и сохранением всех режимов.</li>
	<li>У нас есть опыт производства теплообменников для сушильных камер «Мюльбок-Ваничек» (Muhlbock\Vanicek), Sekal, Incoplan, DryWood.</li>
</ul>
...
<section class="section">
	<h3 >Расчет характеристик теплообменника и коммерческого предложения:</h3>
	<table class="price_table">
	<tr>
	<td nowrap="" >
	<img border="0" src="/public/images/sushilnye.png" width="350" height=""></td>
	<td  align="left">
	<h4>По чертежам</h4>
	<!-- <div id="line_block"> -->
	   <div class="button-in">

		 <a href="/online/"  class="btn btn-secondary">Подробнее</a>
	  </div>
	<!-- </div> -->
	</td>
	</tr>
	...
	<tr>
	<td nowrap="" >
	<img border="0" src="/public/images/TZ.jpg" width="350" height=""></td>
	<td  align="left">
	<h4>По техническому заданию.</h4>
	...
	<tr>
	<td nowrap="" >
	<img border="0" src="/public/images/plastinchatye-medno-alyuminievye-teploobmenniki.png" width="350" height=""></td>
	<td  align="left">
	<h4>По образцам.</h4>
 ...
 <!--  <div class="cert-wr">
<img src="/public/images/sushilnye.png" />
</div>
-->
<section class="section">
<!--<p>У нас есть опыт производства теплообменников для сушильных камер «Мюльбок-Ваничек» (Muhlbock\Vanicek), Sekal, Incoplan, DryWood. </p>

<!-- <p>Срок изготовления теплообменников для сушильных камер древесины — 15-25 рабочих дней (в зависимости от используемых материалов и сложности конструкции).</p> -->

<!-- <p>Все теплообменники после изготовления проходят производственные испытания — проверку на герметичность под давлением не менее 23 атмосфер. </p> -->
</section>
	<section class="section">
