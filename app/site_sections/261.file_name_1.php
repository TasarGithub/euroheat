<img class="brand_logo" src="/public/images/fubag.jpg" />
             <p>Предоставим в аренду дизельную электростанцию Fubag DS 19000 DA ES в шумозащитном кожухе. Предлагаем фиксированные низкие цены для проката в Москве и по области.</p>
<p>Генератор оптимален для постоянного или резервного питания на строительных площадках, в офисных центрах, на складах и в загородных домах. При длительной аренде техники предоставляется скидка.</p>

<br />

<div class="item_col_1">
    <img class="img-responsive" src="/public/images/fubag-13kvt.jpg" alt="Fubag DS 19000" title="Fubag DS 19000 DA ES " /><br />
...
<div class="item_col_2">
    ...
    <table class="char_table">
            ...
            <td>16,5 кВА / 13 кВт</td>
        </tr>
        
                <tr>
            <td>Резервная мощность</td>
            <td>18,7 кВА / 13,8 кВт</td>
        </tr>
...
<p>Чтобы объект питался без перебоев, станцию обслуживает наш оператор. Он подключит генератор на объекте и поможет подвести к нему потребителей. При необходимости возможна круглосуточная работа оператора.</p>
...
<div class="cat_item">
    <div class="cat_col_1">
        <a href="/generatora-fubag/ds15000/"><img src="/public/images/fubag-13kvt-small.jpg" /></a>
    </div>
    <div class="cat_col_2">
        <div class="cat_t"><a href="/generatora-fubag/ds15000/">Fubag DS 15000 DA ES</a></div>
        <div>Ном. мощность: 13,5 кВА / 10,8 кВт</div>
        <div>Резервная мощность: 17,5 кВА / 12 кВт</div>
