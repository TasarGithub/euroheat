...
<div class="gerb_b">
<img src="/public/images/istra_gerb.jpg" />
<br />
Город: Истра<br />
Расстояние от МКАД: 35 км.<br />
Площадь: 7 км2<br />
Население: 34 764 чел.
</div>

<p>Чтобы начать стройку или ремонт дороги в Истре, вовсе необязательно покупать собственный генератор электричества. Мы <a href="/uslugi/dostavka/">доставим электростанцию</a> мощностью от 10 до 1500 кВт из Москвы на ваш адрес в течение суток после заявки.</p>
<p>Мы подаем дизельные генераторы <a href="/uslugi/operator/">с операторами и механиками</a>, а также полностью обеспечиваем вас топливом. Но вы можете взять технику для резервного питания и платить за оборудование в режиме простоя – <a href="/tarify/">по минимальной цене</a>.</p>
<p>Вы можете создать <a href="/uslugi/">собственный пакет услуг</a>, в который мы включим все самое нужное. Нет кабеля для подключения? Привезем. Нужен контейнер для бесшумной работы? Все наши станции поставляются в заводских кожухах.</p>
</div><br /><br />
...
<a class="order_btn calc calc_2" href="#calc_modal" data-toggle="modal"><div class="arrow_2"></div>Рассчитать аренду ДЭС</a><br /><br />
            ...
            <div class="h1"><a href="/tarify/">Цены на прокат электростанций</a></div>
        
<p>В таблице указаны приблизительные расценки на прокат ДГУ. <a href="/raschet/">Рассчитать точную стоимость</a> и обсудить условия доставки можно с нашими специалистами по телефону.</p>
