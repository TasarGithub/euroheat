...
define('PATH_TO_TEMPLATES_SHORT', '/app/templates/'); # echo TEMPLATES_PATH."<hr />";
define('PATH_TO_SITE_SECTIONS', DOCUMENT_ROOT.'/app/site_sections/'); # echo PATH_TO_PUBLIC_SITE_SECTIONS."<hr />";
