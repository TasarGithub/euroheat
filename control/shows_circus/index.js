                ...
                if (data) {
                    try {
                        ...
                        if (result['result'] == 'exists') {
                            $('#show_form_name_alert_div').html('В базе уже существует шоу с названием "' + name + '": <a href="/control/shows_circus/?action=editItem&itemID=' + result['id'] + '" target="_blank">смотреть</a>.<br />Пжл, укажите другое название для шоу.').removeClass('hidden');
