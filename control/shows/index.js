                ...
                if (data) {
                    try {
                        ...
                        if (result['result'] == 'exists') {
                            $('#show_form_name_alert_div').html('¬ базе уже существует шоу с названием "' + name + '": <a href="/control/shows/?action=editItem&itemID=' + result['id'] + '" target="_blank">смотреть</a>.<br />ѕжл, укажите другое название дл€ шоу.').removeClass('hidden');
