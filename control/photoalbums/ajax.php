    ...
    if ($_ = $sth->fetchAll()) {
        ...
        for ($i=0;$i<$_c;$i++) {
            ...
            <tr'.$trClass.'>
                ...
                <td>'.$_[$i]['name'].'</td>
                <td class="center vertical_middle">
                    <a class="block" title="Удалить фотоальбом" href="/control/photoalbums/?action=deleteItem&itemID='.$_[$i]['id'].'" onClick="return confirm(\'Фотография будет удалена безвозвратно. Удалить фотографию?\')">
