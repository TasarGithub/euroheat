$(document).ready(function () {
              ...
              try {
                ...
                if (result["result"] == "exists") {
                  $("#templates_form_name_alert_div")
                    .html(
                      'В базе уже существует файл css-стилей с указанным названием: <a href="/control/edit_css/?action=editItem&itemID=' +
                        result["id"] +
                        '" target="_blank">смотреть</a>.<br />Пжл, укажите другое название для файла.'
                    )
                    .removeClass("hidden");
            ...
            try {
              ...
              if (result["result"] == "exists") {
                $("#templates_form_file_name_alert_div")
                  .html(
                    'В базе уже существует файл css-стилей с указанным именем файла: <a href="/control/edit_css/?action=editItem&itemID=' +
                      result["id"] +
  ...
  $(".checkForErrors").click(function () {
    ...
    if (isError) {
      alert(
        "Необходимо устранить ошибку. После чего можно будет сохранить файл css-стилей."
      );
