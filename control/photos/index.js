                ...
                if (data) {
                    try {
                        ...
                        if (result['result'] == 'exists') {
                            $('#photo_form_name_alert_div').html('В базе уже существует вопрос-ответ с названием "' + name + '": <a href="/control/photos/?action=editItem&itemID=' + result['id'] + '" target="_blank">смотреть</a>.<br />Пжл, укажите другое название для вопроса.').removeClass('hidden');
