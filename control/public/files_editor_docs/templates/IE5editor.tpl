	...
	<tr> 
		<td> 
			<div id="##name##_tab_one" style="display:block;"> 
				<table id="##name##_toolbar1" class="toolbar" style="height:24px" border="0" cellpadding="0" cellspacing="0">
					<tr> 
						##savebutton##
						<!-- begin print -->
				...
				<table id="##name##_toolbar2" class="toolbar" style="height:24px" border="0" cellpadding="0" cellspacing="0">
					<tr> 
			...
			<!-- end ie50_remove -->
			<!-- drop-down menus -->
			<iframe ##secure##width="200" height="180" id="##name##_menu" frameborder="0" style="visibility: hidden; position: absolute; left: 0px; top: 0px; filter:progid:DXImageTransform.Microsoft.Shadow(color=#707070,direction=135,strength=3)"></iframe> 
			<div id="##name##_font-menu" style="display:none"> 
			<div class="off" onClick="parent.wp_change_font(parent.wp_current_obj,'null')" onMouseOver="on(this)" onMouseOut="off(this)">##default##</div>
				##font_menu## 
			</div>
			<div id="##name##_size-menu" style="display:none">
				<div class="off" onClick="parent.wp_change_font_size(parent.wp_current_obj,'null')" onMouseOver="on(this)" onMouseOut="off(this)">##default##</div>
				##size_menu##
			</div>
