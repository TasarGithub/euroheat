...
define('WP_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/control/public/files_editor_images/');
...
define('WP_WEB_DIRECTORY', '/control/public/files_editor_images/');
...
define('IMAGE_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/public/images/');
...
define('IMAGE_WEB_DIRECTORY', '/public/images/');
...
define('DOCUMENT_FILE_DIRECTORY', $_SERVER['DOCUMENT_ROOT'].'/public/images/');
...
define('DOCUMENT_WEB_DIRECTORY', '/control/public/files_editor_images/downloads/');
...
$image_types = '.jpg, .jpeg, .gif, .png, .html, .htm, .pdf, .doc, .rtf, .txt, .xl, .xls, .ppt, .pps, .zip, .tar, .swf, .wmv, .rm, .mov, .jpg, .jpeg, .gif, .png, .ico';
