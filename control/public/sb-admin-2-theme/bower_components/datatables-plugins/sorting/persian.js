...
var persianSort = [ 'РЁСћ', 'РЁВ§', 'РЁРЃ', 'Р©С•', 'РЁР„', 'РЁВ«', 'РЁВ¬', 'РЄвЂ ', 'РЁВ­', 'РЁВ®', 'РЁР‡', 'РЁВ°', 'РЁВ±', 'РЁР†', 'РЄпїЅ',
					'РЁС–', 'РЁТ‘', 'РЁВµ', 'РЁВ·', 'РЁС‘', 'РЁв„–', 'РЁС”', 'Р©Рѓ', 'Р©вЂљ', 'РЄВ©', 'РЄР‡', 'Р©вЂћ', 'Р©вЂ¦', 'Р©вЂ ', 'Р©в‚¬', 'Р©вЂЎ', 'Р«РЉ', 'Р©Р‰' ];
