					...
					if (!master.player.opt.downloadPage) {
						...
						if(isSameDomain && typeof a.download != "undefined"){
							...
							master.player.download = jQuery("<a/>")
									...
									// .attr("title", "Р РЋР С”Р В°РЎвЂЎР В°РЎвЂљРЎРЉ Р В·Р В°Р С—Р С‘РЎРѓРЎРЉ РЎР‚Р В°Р В·Р С–Р С•Р Р†Р С•РЎР‚Р В°.")
									// .attr("title", "123")
 ...
 * Copyright (c) 2006 John Resig, Yehuda Katz, JР“В¶rn Zaefferer, Paul McLanahan
