...
class gatorconf {
	...
	public static function get($param) {
		...
		$config = array(
				...
				'repository' => '/var/www/euroheater/data/www/euroheater.ru/public/',
				...
				'direct_links_baseurl' => 'https://euroheater.ru/public/',
				'direct_links_basedir' => '/var/www/euroheater/data/www/euroheater.ru/public/',
				...
				# 'accept_file_extensions' => array('jpg', 'jpeg', 'gif', 'png', 'pdf', 'doc', 'rtf', 'txt', 'xl', 'xls', 'ppt', 'pps', 'zip', 'tar', 'swf', 'wmv', 'rm', 'mov', 'jpg', 'jpeg', 'gif', 'png'),
