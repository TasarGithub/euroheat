...

{
	...
	$pages = new pages($_GET["page"], # текущая страница
					   ...
					   '/control/online_requests/', # ссылка на 1ю страницу

					   '/control/online_requests/?page=%page%', # ссылка на остальные страницы
...
// конвертация получаемых из базы данных нужна как костыль если часть в utf-8  и всё в win-1251
