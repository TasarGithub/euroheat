...
console.log('скрипты jquery для обработки форм: ');
$(document).ready(function() { // jquery ready
    ...
    $('#contacts_form_submit_button').click(function() {
        console.log('@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@  contacts_form_submit_button: ');
        // setting container for ajax preloader
    ...
    // });
 console.log('###################################################################  BEFOR analog_form_submit_button: ');
    ...
    $('#analog_form_submit_button').click(function() {
        ...
        if (name && phone && email && text) {
            console.log('(name && phone && email && text: ', name, phone, email , text);
