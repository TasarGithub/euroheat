<?php # НАЗНАЧЕНИЕ: ОБРАБОТЧИК ОНЛАЙН-СЕРВИСА "ЗАКАЗАТЬ ОБРАТНЫЙ ЗВОНОК" НА ГЛАВНОЙ И ВНУТРЕННИХ
...
function sendLetterToManager()
{
	...
	"Zayavka na obratnii zvonok:".PHP_EOL.
    ...
    DOMAIN_SHORT.' - заявка на обратный звонок ['.date('j '.getRusMonthName(date('m')).' Y G:i').']',
	# $message.$messageEn,
	$message,
