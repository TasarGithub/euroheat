<?php # НАЗНАЧЕНИЕ: ОБРАБОТЧИК ОНЛАЙН-СЕРВИСА "РАСЧЕТ И ПОДБОР КОНДЕНСАТОРА"

# https://euroheater.ru/raschet-condensatora/
...

{
    ...
    # 'Заявка на расчет и подбор конденсатора:'.PHP_EOL.
	...
	'Zayavka na raschet i podbor kondensatora: '.PHP_EOL.
    ...
    str_replace('www.', '', $_SERVER['SERVER_NAME']).' - заявка на расчет и подбор конденсатора ['.date("j.n.Y G:i").']',
