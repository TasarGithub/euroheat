<?php # НАЗНАЧЕНИЕ: ОБРАБОТЧИК ОНЛАЙН-СЕРВИСА "ЗАЯВКА НА РАСЧЕТ ВОДЯНОГО ОХЛАДИТЕЛЯ"
...

{
    ...
    # 'Заявка на расчет водяного охладителя:'.PHP_EOL.
	...
	'Zayavka na raschet vodyanogo ohladitela: '.PHP_EOL.
    ...
    str_replace('www.', '', $_SERVER['SERVER_NAME']).' - заявка на расчет водяного охладителя ['.date("j.n.Y G:i").']',
...

{
	...
	// если это  НЕ UTF-8 
...

		{
			...
			$var2 = iconv('windows-1251', 'UTF-8//TRANSLIT', $var);
