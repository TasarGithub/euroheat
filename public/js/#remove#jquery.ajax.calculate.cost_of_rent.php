<?php # НАЗНАЧЕНИЕ: ОБРАБОТЧИК ОНЛАЙН-СЕРВИСА "РАСЧЕТ СТОИМОСТИ АРЕНДЫ" НА ГЛАВНОЙ И ВНУТРЕННИХ

# дата создания: 2015.12.15
...

{
    ...
    "Заявка на обратный звонок:".PHP_EOL.
	...
	$_SERVER['SERVER_NAME'].' - заявка на расчет стоимости аренды ['.date("j.n.Y G:i").']',

	$message.$messageEn,

	'From: www@'.$_SERVER['SERVER_NAME'].PHP_EOL.
