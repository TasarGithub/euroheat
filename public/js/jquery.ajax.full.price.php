<?php # НАЗНАЧЕНИЕ: ОБРАБОТЧИК ОНЛАЙН-СЕРВИСА "Запросить полный прайс-лист": https://euroheater.ru/price/
# дата создания: 2018.01.09
...
function sendLetterToManager()
{
	...
	$message =
    # "Запрос полного прайс-листа:".PHP_EOL.
	...
	"Zapros polnogo prais lista:".PHP_EOL.
    "Imya: ".$_POST['name_en'].PHP_EOL.
    "E-mail: ".$_POST['email_en'].PHP_EOL.
    ...
    DOMAIN_SHORT.' - запрос полного прайс-листа ['.date('j '.getRusMonthName(date('m')).' Y G:i').']',
	$message.$messageEn,
