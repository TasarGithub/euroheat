    ...
    function (e, t, n) {
      ...
      "object" ===
        ...
        o.appendChild(
          document.createTextNode(
            // удалил текст css, перенёс его в fslightbox.css
            ""
          )
        ),
      ...
      function I(e, t) {
        var n = e.collections.sourceLoadHandlers,
          ...
          s = e.props.sources;
        var alt = e.props.customAttributes,
          pAlt;
        ...
        pAlt.textContent = i[t].alt;
        pAlt.className = "fslightbox-caption";
        r[t].appendChild(pAlt);
        // i[t] = document.createElement("img");
      ...
      function le() {
        ...
        t = function (t) {
          ...
          // если нет, то задается ссылка на картинку o: "/images/cases/case-1-big.jpg"
